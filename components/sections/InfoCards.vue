                    ...
                    >
                      ...
                      >
                        <UiStyledButton
                          ...
                          :text="service.text"
                          :do-hover="
                            hover && s_index + 1 == card.services.length
                          "
                        />
                      </v-col>
                    </v-row>
