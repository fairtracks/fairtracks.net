<template>
  <v-row v-if="subSection.tables" class="px-md-16 pb-md-16 px-8 pb-8 pt-0" justify="center">
    <div
      v-for="(table, t_index) in subSection.tables"
      :key="t_index"
    ...
    >
      <UiMarkdownTable
        ...
        :collapse-large-lists="table.collapseLargeLists ? table.collapseLargeLists : true"
