    ...
    return {
      ...
      githubIssues: {
        ...
        repos: [
          ...
          {
            title: 'TrackFind',
            issuesLink: 'https://github.com/elixir-oslo/trackfind/issues',
          },
          {
        ...
        endCommentPageLink: '',
        endCommentPageText: 'source code page (coming soon...)',
      },
      citeUsTitle: 'Cite us!',
      citeUsText:
      ...
      logos: [
        ...
        { filename: 'elixir-spain.png' },
        { filename: 'embl-ebi.svg', width: '587', height: '181' },
        { filename: 'inb.png' },
        { filename: 'bsc.jpeg' },
        { filename: 'rcn.png' },
        { filename: 'uio.png' },
