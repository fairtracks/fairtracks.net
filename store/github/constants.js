...
export const GITHUB_G_GET_REPO_FIRST_COMMIT_DATE = NAMESPACE + G_GET_REPO_FIRST_COMMIT_DATE
export const GITHUB_G_GET_REPO_LAST_COMMIT_DATE = NAMESPACE + G_GET_REPO_LAST_COMMIT_DATE
export const GITHUB_G_GET_REPO_COMMIT_COUNT = NAMESPACE + G_GET_REPO_COMMIT_COUNT
export const GITHUB_G_GET_REPO_TOP_COMMITTERS = NAMESPACE + G_GET_REPO_TOP_COMMITTERS
